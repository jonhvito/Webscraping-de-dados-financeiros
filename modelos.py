...
class FundoImobiliario:
     def __init__(self, codigo, segmento, cotacao_atual, ffo_yield, dividiend_yield, p_pv, valor_mercado, liquidez,
...
class Estrategia:
    def __init__(self,segmento="",  cotacao_atual_minima=0, ffo_yield_minimo=0, dividiend_yield_minimo=0,
                 p_pv_minimo=0, valor_mercado_minimo=0, liquidez_mercado_minima=0,
                 qt_minima_imoveis=0, valor_minimo_preco_m2=0, valor_minimo_aluguel_m2=0,
        ...
        self.liquidez_mercado_minima = liquidez_mercado_minima
    ...
    def aplica_estrategia(self, fundo:FundoImobiliario):
        ...
        if fundo.cotacao_atual < self.cotacao_atual_minima \
                ...
                or fundo.liquidez < self.liquidez_mercado_minima\
